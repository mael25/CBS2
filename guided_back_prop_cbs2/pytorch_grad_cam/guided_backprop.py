...
class GuidedBackpropReLUModel:
    ...
    def forward(self, input_img, velocity, command):
        return self.model(input_img, velocity, command)
    ...
    def __call__(self, input_img, velocity, command, target_category=None):
        ...
        output = self.forward(input_img, velocity, command)
