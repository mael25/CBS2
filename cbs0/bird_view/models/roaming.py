...
class RoamingAgentMine(Agent):
    def __init__(self, vehicle, resolution, threshold_before, threshold_after):
        ...
        self._proximity_threshold = 8.5
        #self._proximity_threshold = 5.5 # REVERT TO 9JUNE

        self._proximity_threshold_walker = 5.5
        self._proximity_threshold_vehicle = 5.5
        ...
        self.is_at_walker = None
        self.is_at_vehicle = None

        self.debug = dict()

    def run_step(self, inputs=None, debug=False, debug_info=None):
        self.is_at_red_light = False
        self.is_at_walker = False
        self.is_at_vehicle = False
